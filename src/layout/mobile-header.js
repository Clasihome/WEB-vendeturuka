...
export default ()=> {
  ...
  return(
    ...
    <NavPanel visible={open}>
      ...
      <NavList>
        <NavItem>
          <Link paintDrip hex={state.primaryColor} to="/properties" onClick={()=> setOpen(false)} duration={.5}>
            <NavLink light>
              Propiedades
            </NavLink>
          </Link>
        ...
        <NavItem>
          <Link paintDrip hex={state.primaryColor} to="/about" onClick={()=> setOpen(false)} duration={.5}>
            <NavLink light>
              Nosotros
            </NavLink>
          </Link>
        ...
        <NavItem>
          <Link paintDrip hex={state.primaryColor} to="/contact" onClick={()=> setOpen(false)} duration={.5}>
            <NavLink light>
              Contacto
            </NavLink>
          </Link>
