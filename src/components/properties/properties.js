...
import { ArrowLeftOutlined, ArrowRightOutlined, LoadingOutlined, FrownOutlined } from '@ant-design/icons';
              ...
              <Col xs={12}>
                <NavPaginate>
                  <ReactPaginate
                    ...
                    previousLabel={<ArrowLeftOutlined style={{ fontSize: 24 }} />}
                    nextLabel={<ArrowRightOutlined style={{ fontSize: 24 }} />}
