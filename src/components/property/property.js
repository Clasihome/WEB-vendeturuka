    ...
    <Fragment>
      <CharsContainer more={more.chars}>
        ...
        <MoreButton onClick={() => setMore({ chars: !more.chars })}>
          ...
          {more.chars ? (
            <UpOutlined style={{ marginLeft: ".5rem" }} />
          ) : (
            <DownOutlined style={{ marginLeft: ".5rem" }} />
          )}
        </MoreButton>
      </CharsContainer>
      ...
      {state.ubication &&
        state.ubication.location &&
        state.ubication.location.coordinates && (
          <MapContainer>
            <MapTitle>Ubicación</MapTitle>
            <Map
